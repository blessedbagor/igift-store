...
// Dynamically import MapContainer and its children with SSR disabled
...
<div className="flex justify-center items-center min-h-screen">
  <Card className="w-full max-w-6xl p-4" style={{ height: '80vh' }}> {/* Added padding and defined height */}
    <MapContainer
      center={[12.8797, 121.774]}
      zoom={6}
      style={{
        height: '100%',  // Make the map fill the entire card's height
        width: '100%',
        padding: '0', // Remove internal padding to prevent overflow
        boxSizing: 'border-box', // Ensure padding and border are included in the element's total size
      }}
    >
