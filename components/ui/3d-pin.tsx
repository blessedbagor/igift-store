    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl  shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-black border border-gold/[0.2] group-hover/pin:border-gold/[0.3] transition duration-700 overflow-hidden"
        >
    ...
    <motion.div className="pointer-events-none  w-96 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        ...
        <>
          ...
          <motion.div className="absolute right-1/2 translate-x-[1.5px] bottom-1/2 bg-realGreen translate-y-[14px] w-[4px] h-[4px] rounded-full z-40 blur-[3px]" />
